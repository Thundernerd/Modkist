...
namespace ModIO
{
    ...
    public class SystemIOWrapper : IPlatformIO, IUserDataIO, IUserDataIO<string>, IUserDataIO<int>
    {
        ...
        {
            this.installationDirectory = System.IO.Path.Combine(TNRD.Preferences.GamePath, "BepInEx", "plugins");
        ...
        public string InstallationDirectory => installationDirectory;
        ...
        public static void TNRD_MoveDirectory(string source, string target)
        {
        ...
        public virtual bool MoveDirectory(string source, string destination)
        {
            ...
            try
            {
                ...
                TNRD_MoveDirectory(source, destination);
